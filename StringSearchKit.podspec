#
# Be sure to run `pod lib lint StringSearchKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of StringSearchKit.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'mabidakun' => 'mike@mikeosoft.co.uk' }
